...
class AnnouncesControllerTest < ActionController::TestCase
  ...
  test "should create announce" do
    assert_difference('Announce.count') do
      post :create, announce: { description: @announce.description, email: @announce.email, name: @announce.name, phone: @announce.phone, price: @announce.price, title: @announce.title }
    end
  ...
  test "should update announce" do
    patch :update, id: @announce, announce: { description: @announce.description, email: @announce.email, name: @announce.name, phone: @announce.phone, price: @announce.price, title: @announce.title }
    assert_redirected_to announce_path(assigns(:announce))
  end
